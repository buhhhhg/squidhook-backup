...
local Menu, Toggles, Options = pcall(function() loadstring(game:HttpGet("https://pastebin.com/raw/UhVM4fwm", true))() end) or loadstring(game:HttpGet("https://raw.githubusercontent.com/buhhhhg/squidhook-backup/refs/heads/main/drawinglib.lua", true))()
local SaveManager = pcall(function() loadstring(game:HttpGet("https://raw.githubusercontent.com/theonlylegacy/Libraries/main/Addons/SaveManager.lua"))() end) or loadstring(game:HttpGet("https://raw.githubusercontent.com/buhhhhg/squidhook-backup/refs/heads/main/SaveManager.lua", true))()
local Flags = {
    ["Player Select"] = nil,
